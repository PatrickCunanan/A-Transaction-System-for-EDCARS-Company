				...
				<table id="example" class="table" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<TR>
							...
							<TD><%= resultset.getString("carBrand") %>
							</TD>
							...
							<form action="sendBuyRequest.html" method="post">
								<input type="hidden" name = "carBrand" value=<%= resultset.getString("carBrand") %>>
								<input type="hidden" name = "carModel" value=<%= resultset.getString("carModel") %>>
								<input type="hidden" name = "carType" value=<%= resultset.getString("carType") %>>
								<input type="hidden" name = "carColour" value=<%= resultset.getString("carColour") %>>
								<input type="hidden" name = "carYear" value=<%= resultset.getInt("carYear") %>>
								<input type="hidden" name = "carPrice" value=<%= resultset.getDouble("carPrice") %>>
								<input type="submit" value="BUY" class="btn btn-info btn-fill"/>
							</form>
							</td>
						</TR>
