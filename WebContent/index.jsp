...
<script>
	function printPage(id) {
		var html = "<html><h4>EDCARS Inventory and Transaction Report Log</h4>";
		...
		<div class="sidebar" data-color data-image="assets/img/sidebar.jpg">
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li><a href="manageinventory.html"> <i class="pe-7s-note2"></i>
							<p>Manage Inventory</p>
					</a></li>
					<li><a href="transaction.html"> <i class="pe-7s-ribbon"></i>
							<p>Transaction</p>
					</a></li>
					<li><a href="managewebsite.html"> <i class="pe-7s-science"></i>
							<p>Manage Website</p>
					</a></li>
				</ul>
			</div>
